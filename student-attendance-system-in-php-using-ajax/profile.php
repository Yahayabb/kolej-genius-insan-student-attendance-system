    ...
    <form method="post" id="profile_form" enctype="multipart/form-data">
		...
		<div class="card-body">
			<div class="form-group">
				<div class="row">
					<label class="col-md-4 text-right">Lecturer's Name <span class="text-danger">*</span></label>
					<div class="col-md-8">
			...
			<div class="form-group">
				<div class="row">
					<label class="col-md-4 text-right">Foundation <span class="text-danger">*</span></label>
					<div class="col-md-8">
